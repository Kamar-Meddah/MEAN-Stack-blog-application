...
add(request,response){
  const fs=require('fs');
  this.articles.create({"titre":request.body.titre,"contenu":request.body.content,"category_id":request.body.category},(postId)=>{
    const images=require('../app').getTable('images');
...
edit(request,response){
    const fs=require('fs');
    let r=[];
    this.articles.update(request.body.id,{'titre':request.body.titre,'contenu':request.body.content,'category_id':request.body.category},()=>{
      const images=require('../app').getTable('images');
